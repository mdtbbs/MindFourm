...
exports.AutoPostModule = AutoPostModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([post_entity_1.Post, category_entity_1.Category, notification_entity_1.Notification])],
        controllers: [auto_post_controller_1.AutoPostController],
        providers: [auto_post_service_1.AutoPostService],
        exports: [auto_post_service_1.AutoPostService],
    })
], AutoPostModule);
