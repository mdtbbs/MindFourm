...
let RssController = class RssController {
    ...
    async getPostsRss(res) {
        const xml = await this.rssService.generatePostsRss();
        res.send(xml);
    }
    async getCategoryRss(slug, res) {
...
__decorate([
    (0, common_1.Get)('posts.xml'),
    (0, common_1.Header)('Content-Type', 'application/rss+xml; charset=utf-8'),
    __param(0, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], RssController.prototype, "getPostsRss", null);
__decorate([
    (0, common_1.Get)('categories/:slug.xml'),
    (0, common_1.Header)('Content-Type', 'application/rss+xml; charset=utf-8'),
    ...
    __metadata("design:returntype", Promise)
], RssController.prototype, "getCategoryRss", null);
