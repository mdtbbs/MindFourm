...
export default function LoginPage() {
  useEffect(() => {
    const mindauthUrl = process.env.NEXT_PUBLIC_MINDAUTH_URL || 'http://localhost:4501';
  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      <div className="text-center">
        ...
        <p className="mt-2 text-sm text-[var(--text-muted)]">如果没有自动跳转，<a href="#" onClick={() => window.location.reload()} className="text-[var(--primary)] hover:underline">点击这里</a></p>
      </div>
    </div>
  );
}
