...
android { namespace = "cn.mdtbbs.android"; compileSdk = 35
  defaultConfig { applicationId = "cn.mdtbbs.android"; minSdk = 26; targetSdk = 35; versionCode = 100; versionName = "0.1.0"; buildConfigField("String", "API_BASE_URL", "\"https://mdtbbs.cn/\"") }
...
dependencies {
  ...
  implementation("androidx.compose.material3:material3"); implementation("androidx.compose.ui:ui-tooling-preview"); debugImplementation("androidx.compose.ui:ui-tooling")
