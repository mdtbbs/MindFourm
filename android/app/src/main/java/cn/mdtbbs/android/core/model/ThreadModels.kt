...
data class ThreadReply(val id: Long, val userId: Long, val parentReplyId: Long?, val content: String, val author: Author, val createdAt: Instant, val updatedAt: Instant, val isOwner: Boolean = false)
